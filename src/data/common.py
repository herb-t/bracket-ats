...
content = {
    ...
    'tiles': [
        ...
        {
            'title': 'Hercules Docs Site',
            'image': 'space-kittens.jpg',
            'link': 'https://hercules-docs.appspot.com/',
            'description': 'go/herc-docs'
        },
        {
            'title': 'Glue/Hercules Forum',
    ...
    'tabby': [
        ...
        },
        {
            'id': 'hercules',
            'title': 'Hercules',
            'content': u'Hercules is an HTML/SASS library for creating Google branded marketing and informational sites. It’s a subset of Glue containing markup and styles to create things like headers, footers, and buttons. It pairs well with Glue Javascript components, but you can use the SASS/CSS on its own.',
        },
    ],
}